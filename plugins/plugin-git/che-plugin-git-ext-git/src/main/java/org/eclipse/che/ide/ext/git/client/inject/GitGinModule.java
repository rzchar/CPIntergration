...
public class GitGinModule extends AbstractGinModule {
  ...
  protected void configure() {
    ...
    bind(org.eclipse.che.ide.ext.git.client.cldiff.revisionslist.RevisionListView.class)
        .to(org.eclipse.che.ide.ext.git.client.cldiff.revisionslist.RevisionListViewImpl.class)
        .in(Singleton.class);

    bind(org.eclipse.che.ide.ext.git.client.cldiff.changeslist.ChangesListView.class)
        .to(org.eclipse.che.ide.ext.git.client.cldiff.changeslist.ChangesListViewImpl.class)
        .in(Singleton.class);

    bind(org.eclipse.che.ide.ext.git.client.cldiff.branchlist.BranchListView.class)
        .to(org.eclipse.che.ide.ext.git.client.cldiff.branchlist.BranchListViewImpl.class)
        .in(Singleton.class);

    bind(org.eclipse.che.ide.ext.git.client.cldiff.changespanel.ChangesPanelView.class)
        .to(org.eclipse.che.ide.ext.git.client.cldiff.changespanel.ChangesPanelViewImpl.class);

    bind(org.eclipse.che.ide.ext.git.client.cldiff.selectablechangespanel.SelectableChangesPanelView
            .class)
        .to(
            org.eclipse.che.ide.ext.git.client.cldiff.selectablechangespanel
                .SelectableChangesPanelViewImpl.class);
