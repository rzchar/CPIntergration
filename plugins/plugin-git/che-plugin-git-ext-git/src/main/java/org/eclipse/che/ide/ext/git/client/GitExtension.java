...
import org.eclipse.che.ide.ext.git.client.action.CLDIFFWithLatestAction;
...
public class GitExtension {
  ...
  public static final String CLDIFF_GROUP_MAIN_MENU = "CLDIFF";
  public static final String CLDIFF_COMPARE_WITH_LATEST = "cldiffCompareWithLatest";
  ...
  public GitExtension(
      ...
      CLDIFFWithLatestAction cldiffWithLatestAction,
    ...
    /*DefaultActionGroup cldiff = new DefaultActionGroup(CLDIFF_GROUP_MAIN_MENU, true, actionManager);
    actionManager.registerAction("cldiff", cldiff);
    mainMenu.add(cldiff, new Constraints(BEFORE, GROUP_PROFILE));

    actionManager.registerAction(CLDIFF_COMPARE_WITH_LATEST, cldiffWithLatestAction);
    cldiff.add(cldiffWithLatestAction);*/
  }
}
