...
public class HistoryPresenter implements HistoryView.ActionDelegate {
  ...
  private final org.eclipse.che.ide.ext.git.client.cldiff.ComparePresenter cldiffPresenter;
  ...
  public HistoryPresenter(
      org.eclipse.che.ide.ext.git.client.cldiff.ComparePresenter cldiffPresenter,
      HistoryView view,
    ...
    this.view = view;
    this.cldiffPresenter = cldiffPresenter;
    ...
    service
        ...
        .then(
            diff -> {
              ...
              String revisionA2 = revisionA;
              if (revisionA2 == null) revisionA2 = "null";
              cldiffPresenter.showCLDIFF(revisionA2, revisionB, projectName);
            })
        .catchError(
            error -> {
              notificationManager.notify(locale.diffFailed(), FAIL, EMERGE_MODE);
