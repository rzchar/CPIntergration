...
import org.eclipse.che.ide.ext.git.client.cldiff.FileStatus.Status;
...
public class ComparePresenter implements CompareView.ActionDelegate {
  ...
  public void showCLDIFF(String revisionA, String revisionB, String projectName) {
    view.setColumnTitles(revisionA, revisionB, projectName);
    view.show("aaaa", "bbbb", "cccc", true);
  }
          ...
          .then(
              content -> {
                ...
                view.setColumnTitles(
                    locale.compareYourVersionTitle(),
                    revision + locale.compareReadOnlyTitle(),
                    "lalalacldiff");
